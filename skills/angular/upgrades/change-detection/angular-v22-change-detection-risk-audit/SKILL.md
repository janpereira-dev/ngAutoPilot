---
id: angular.upgrades.change-detection.angular-v22-change-detection-risk-audit
name: Angular v22 Change Detection Risk Audit
description: >
  Use this skill for Find code that depended on eager change detection, implicit zones, or mutation-driven refreshes. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
...
Find code that depended on eager change detection, implicit zones, or mutation-driven refreshes.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves find code that depended on eager change detection, implicit zones, or mutation-driven refreshes.
...
- Use this skill to review `change detection audit` in an Angular 22 migration.
