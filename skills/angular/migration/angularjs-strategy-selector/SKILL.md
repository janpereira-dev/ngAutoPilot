...
Use this skill to handle AngularJS to Angular migration planning for angularjs strategy selector in AngularJS, Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angularjs strategy selector, AngularJS inventory, ngUpgrade, hybrid routing, services, templates, or decommissioning;
...
1. State the angular.migration.angularjs-strategy-selector diagnosis in one concise paragraph.
