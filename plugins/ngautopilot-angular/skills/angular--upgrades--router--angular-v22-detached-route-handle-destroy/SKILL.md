---
id: angular.upgrades.router.angular-v22-detached-route-handle-destroy
name: Angular v22 Detached Route Handle Destroy
description: >
  Use this skill for Use official detached route handle destruction instead of private RouteReuseStrategy workarounds. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: router
...
triggers:
  ...
  - RouteReuseStrategy
  - detached route
  - Angular v22 Detached Route Handle Destroy
  - Router
  - Angular 22
compatibility:
  angular:
...
Use official detached route handle destruction instead of private RouteReuseStrategy workarounds.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use official detached route handle destruction instead of private routereusestrategy workarounds.
...
- Use this skill to review `destroyDetachedRouteHandle` in an Angular 22 migration.
