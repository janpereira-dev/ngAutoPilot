---
id: angular.upgrades.components.angular-v22-host-directives-deduplication
name: Angular v22 Host Directives Deduplication
description: >
  Use this skill for Account for host directive de-duplication and template-match precedence. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: components
...
triggers:
  ...
  - deduplication
  - template match wins
  - Angular v22 Host Directives Deduplication
...
Account for host directive de-duplication and template-match precedence.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves account for host directive de-duplication and template-match precedence.
...
- Use this skill to review `hostDirectives` in an Angular 22 migration.
