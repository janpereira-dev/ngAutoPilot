...
Use this skill to handle Angular SSR and hydration readiness for angular ssr readiness audit in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular ssr readiness audit, SSR safety, hydration risk, browser APIs, or server rendering readiness;
...
1. State the angular.ssr.angular-ssr-readiness-audit diagnosis in one concise paragraph.
