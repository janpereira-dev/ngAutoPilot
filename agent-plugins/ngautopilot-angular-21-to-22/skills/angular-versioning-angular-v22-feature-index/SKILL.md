---
name: angular-versioning-angular-v22-feature-index
description: "Use this skill for Index production-ready and experimental Angular 22 features and route them to concern-first skills. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs."
license: MIT
metadata:
  ngautopilot-id: "angular.versioning.angular-v22-feature-index"
  ngautopilot-source: "skills/angular/versioning/angular-v22-feature-index/SKILL.md"
  ngautopilot-version: "0.5.3"
---


# Angular v22 Feature Index

## Purpose

Index production-ready and experimental Angular 22 features and route them to concern-first skills.
...
- Use this skill to review `Angular v22 feature index` in an Angular 22 migration.
