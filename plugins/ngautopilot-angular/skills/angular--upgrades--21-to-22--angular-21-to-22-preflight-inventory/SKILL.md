---
id: angular.upgrades.21-to-22.angular-21-to-22-preflight-inventory
name: Angular 21 to 22 Preflight Inventory
description: >
  Use this skill for Inventory Angular 21 project risks before changing dependencies. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: upgrade
...
triggers:
  - v22 preflight
  - Angular 21 inventory
  - upgrade inventory
  - Angular 21 to 22 Preflight Inventory
  - Hop 21 to 22
  - Angular 22
compatibility:
  angular:
...
Inventory Angular 21 project risks before changing dependencies.
...
- Use this skill to review `v22 preflight` in an Angular 22 migration.
