---
id: angular.upgrades.forms.angular-v22-signal-forms-production-patterns
name: Angular v22 Signal Forms Production Patterns
description: >
  Use this skill for Adopt Signal Forms for production while preserving validation, submit, accessibility, and migration boundaries. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: forms
...
triggers:
  ...
  - form()
  - FieldTree
  - Angular v22 Signal Forms Production Patterns
  - Forms / Signal Forms
  - Angular 22
compatibility:
  angular:
...
Adopt Signal Forms for production while preserving validation, submit, accessibility, and migration boundaries.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves adopt signal forms for production while preserving validation, submit, accessibility, and migration boundaries.
...
Angular 22 changes forms / signal forms behavior enough that agents need a narrow checklist instead of a generic v22 bucket. The goal is to make the risk visible, testable, and reviewable.
...
- validation rules
- form templates
- CVA or Material/Aria integrations
...
- Use this skill to review `Signal Forms` in an Angular 22 migration.
