---
id: angular.router.angular-router-testing-patterns
name: Angular Router Testing Patterns
description: Test Angular routing, guards, resolvers, and lazy routes with stable patterns and minimal fragility.
stack:
  - Angular
category: router
status: stable
...
Use this skill to handle Angular router design for angular router testing patterns in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular router testing patterns, route configuration, lazy loading, guards, resolvers, or router tests;
...
1. State the angular.router.angular-router-testing-patterns diagnosis in one concise paragraph.
