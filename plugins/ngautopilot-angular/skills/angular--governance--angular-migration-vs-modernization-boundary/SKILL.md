...
Use this skill to handle Angular governance classification for angular migration vs modernization boundary in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.

This skill keeps the governance decision explicit: identify the current state, choose the smallest safe action, document compatibility evidence, and leave a validation path that another agent or maintainer can repeat.

## When to Use

Use this skill when:

- the task mentions angular migration vs modernization boundary, migration boundaries, compatibility evidence, validation contracts, or change classification;
- an Angular codebase needs a scoped governance decision before implementation;
...
- [ ] The governance scope is isolated from unrelated work.
...
1. State the angular.governance.angular-migration-vs-modernization-boundary diagnosis in one concise paragraph.
