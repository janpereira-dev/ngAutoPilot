---
id: angular.upgrades.forms.angular-v22-signal-forms-async-validation
name: Angular v22 Signal Forms Async Validation
description: >
  Use this skill for Design async validation with debounce, pending state, reloadValidation, and race-safety. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: forms
...
triggers:
  ...
  - async validation
  - reloadValidation
  - Angular v22 Signal Forms Async Validation
  - Forms / Signal Forms
  - Angular 22
compatibility:
  angular:
...
Design async validation with debounce, pending state, reloadValidation, and race-safety.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves design async validation with debounce, pending state, reloadvalidation, and race-safety.
...
- Use this skill to review `validateAsync` in an Angular 22 migration.
