...
description: Inventory AngularJS surface area, upgrade constraints, and legacy dependencies before any migration work.
stack:
  - AngularJS
  - Angular
category: migration
...
Use this skill to handle AngularJS to Angular migration planning for angularjs legacy inventory in AngularJS, Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angularjs legacy inventory, AngularJS inventory, ngUpgrade, hybrid routing, services, templates, or decommissioning;
...
1. State the angular.migration.angularjs-legacy-inventory diagnosis in one concise paragraph.
