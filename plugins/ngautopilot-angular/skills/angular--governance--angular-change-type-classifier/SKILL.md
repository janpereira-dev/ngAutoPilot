...
Use this skill to handle Angular governance classification for angular change type classifier in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular change type classifier, migration boundaries, compatibility evidence, validation contracts, or change classification;
...
1. State the angular.governance.angular-change-type-classifier diagnosis in one concise paragraph.
