---
id: angular.upgrades.components.angular-v22-createcomponent-modern-api
name: Angular v22 CreateComponent Modern API
description: >
  Use this skill for Use modern ViewContainerRef.createComponent(Component) or createComponent APIs with explicit injector/projectable nodes. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: components
...
- Use this skill to review `createComponent` in an Angular 22 migration.
