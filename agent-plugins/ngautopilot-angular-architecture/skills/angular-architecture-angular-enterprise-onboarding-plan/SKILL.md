---
name: angular-architecture-angular-enterprise-onboarding-plan
description: "Designs Angular enterprise onboarding paths that ramp developers through project conventions, architecture boundaries, testing discipline, and version-aware delivery expectations."
license: MIT
metadata:
