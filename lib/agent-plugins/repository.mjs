...
export function resolveAngularInstallation({ root, projectRoot, target, profile = 'core', capabilities = [] }) {
  ...
  return {
    ...
    excluded: [
      ...incompatibleSkills.map(({ skill, packIds, compatibility }) => ({ type: 'skill', id: skill.id, reason: skillReason(incompatibilityReason(compatibility, effectiveAngularMajor), packIds) })),
