---
id: angular.upgrades.testing.angular-v22-onpush-zoneless-testing-gate
name: Angular v22 OnPush Zoneless Testing Gate
description: >
  Use this skill for Fix tests that relied on implicit zones or eager change detection timing. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: testing
...
triggers:
  ...
  - OnPush testing
  - fakeAsync
  - Angular v22 OnPush Zoneless Testing Gate
  - Testing
  - Angular 22
compatibility:
  angular:
...
Fix tests that relied on implicit zones or eager change detection timing.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves fix tests that relied on implicit zones or eager change detection timing.
...
- Use this skill to review `zoneless testing` in an Angular 22 migration.
