...
description: Migrate AngularJS services to Angular services and injectables with a bounded compatibility plan.
stack:
  - AngularJS
  - Angular
category: migration
...
Use this skill to handle AngularJS to Angular migration planning for angularjs service migration in AngularJS, Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angularjs service migration, AngularJS inventory, ngUpgrade, hybrid routing, services, templates, or decommissioning;
...
1. State the angular.migration.angularjs-service-migration diagnosis in one concise paragraph.
