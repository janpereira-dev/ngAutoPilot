---
name: angular-versioning-angular-peer-dependency-audit
description: "Audit Angular peer dependencies and transitive blockers before applying an upgrade or refactor."
license: MIT
metadata:
  ngautopilot-id: "angular.versioning.angular-peer-dependency-audit"
  ngautopilot-source: "skills/angular/versioning/angular-peer-dependency-audit/SKILL.md"
...
Use this skill to handle Angular version compatibility for angular peer dependency audit in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular peer dependency audit, compatibility matrix, peer dependencies, CLI builders, Node, TypeScript, or RxJS versions;
- an Angular codebase needs a scoped versioning decision before implementation;
...
- [ ] The versioning scope is isolated from unrelated work.
...
1. State the angular.versioning.angular-peer-dependency-audit diagnosis in one concise paragraph.
