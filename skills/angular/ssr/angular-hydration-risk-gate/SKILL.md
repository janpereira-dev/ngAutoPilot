...
Use this skill to handle Angular SSR and hydration readiness for angular hydration risk gate in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular hydration risk gate, SSR safety, hydration risk, browser APIs, or server rendering readiness;
- an Angular codebase needs a scoped ssr decision before implementation;
...
- [ ] The ssr scope is isolated from unrelated work.
...
1. State the angular.ssr.angular-hydration-risk-gate diagnosis in one concise paragraph.
