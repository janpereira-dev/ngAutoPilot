---
id: angular.upgrades.resources.angular-v22-resource-production-patterns
name: Angular v22 Resource Production Patterns
description: >
  Use this skill for Use resource() safely for async signal state with explicit params, loader, states, and errors. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: resources
...
triggers:
  ...
  - async reactivity
  - loader
  - Angular v22 Resource Production Patterns
  - Resources / HTTP
  - Angular 22
compatibility:
  angular:
...
Use resource() safely for async signal state with explicit params, loader, states, and errors.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use resource() safely for async signal state with explicit params, loader, states, and errors.
...
- Use this skill to review `resource` in an Angular 22 migration.
