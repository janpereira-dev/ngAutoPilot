---
id: angular.upgrades.router.angular-v22-component-input-binding-options
name: Angular v22 Component Input Binding Options
description: >
  Use this skill for Control route-to-component input binding behavior and missing input handling. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: router
...
triggers:
  ...
  - Angular v22 Component Input Binding Options
  - Router
  - Angular 22
compatibility:
  angular:
...
Control route-to-component input binding behavior and missing input handling.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves control route-to-component input binding behavior and missing input handling.
...
- Use this skill to review `component input binding` in an Angular 22 migration.
