---
id: angular.upgrades.build.angular-v22-webpack-builder-deprecation-gate
name: Angular v22 Webpack Builder Deprecation Gate
description: >
  Use this skill for Identify webpack/devkit builder deprecations and plan the supported application builder path. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: build
...
triggers:
  ...
  - devkit builder
  - builder deprecation
  - Angular v22 Webpack Builder Deprecation Gate
  - Build / Tooling
  - Angular 22
compatibility:
  angular:
...
Identify webpack/devkit builder deprecations and plan the supported application builder path.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves identify webpack/devkit builder deprecations and plan the supported application builder path.
...
- Use this skill to review `webpack builder` in an Angular 22 migration.
