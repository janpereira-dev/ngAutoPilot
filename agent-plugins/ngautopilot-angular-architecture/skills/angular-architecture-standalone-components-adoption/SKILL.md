---
name: angular-architecture-standalone-components-adoption
description: "Adopt Angular standalone components after an Angular upgrade when the app is stable on Ivy and the goal is architectural modernization rather than a version hop. Use when the project is ready to reduce NgModule usage incrementally or convert bounded feature areas without mixing the change into the upgrade itself."
license: MIT
metadata:
  ngautopilot-id: "angular.architecture.standalone-components-adoption"
  ngautopilot-source: "skills/angular/architecture/standalone-components-adoption/SKILL.md"
