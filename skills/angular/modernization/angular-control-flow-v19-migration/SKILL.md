---
id: angular.modernization.angular-control-flow-v19-migration
name: Angular Control Flow v19 Migration
description: >
  Adopt Angular built-in control flow syntax in bounded post-upgrade modernization slices after Angular 19 is stable. Use when replacing *ngIf, *ngFor, and *ngSwitch with @if, @for, and @switch in a controlled feature slice, not during a version hop.
stack:
  - Angular
  - TypeScript
...
# Angular Control Flow v19 Migration

## Purpose

Adopt Angular built-in control flow syntax in bounded modernization slices after Angular 19 is stable.
