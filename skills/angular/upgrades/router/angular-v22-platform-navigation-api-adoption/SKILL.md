---
id: angular.upgrades.router.angular-v22-platform-navigation-api-adoption
name: Angular v22 Platform Navigation API Adoption
description: >
  Use this skill for Adopt withExperimentalPlatformNavigation only with router, scroll, accessibility, and browser-behavior checks. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: router
...
triggers:
  ...
  - Navigation API
  - router
  - Angular v22 Platform Navigation API Adoption
  - Router
  - Angular 22
compatibility:
  angular:
...
Adopt withExperimentalPlatformNavigation only with router, scroll, accessibility, and browser-behavior checks.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves adopt withexperimentalplatformnavigation only with router, scroll, accessibility, and browser-behavior checks.
...
- Use this skill to review `withExperimentalPlatformNavigation` in an Angular 22 migration.
