...
triggers:
  ...
  - upgrade risk
  - non technical
  - Angular v22 Upgrade Risk Plain Language
  - Education
  - Angular 22
compatibility:
  angular:
...
Explain why an Angular upgrade is not just changing a version number.
...
- Use this skill to review `plain language` in an Angular 22 migration.
