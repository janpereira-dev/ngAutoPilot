---
id: angular.material.angular-cdk-a11y-patterns
name: Angular CDK A11y Patterns
description: Apply Angular CDK accessibility primitives with explicit keyboard, focus, and announcement behavior.
stack:
  - Angular
category: material
status: stable
...
Use this skill to handle Angular Material implementation guidance for angular cdk a11y patterns in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular cdk a11y patterns, CDK accessibility, ARIA, theming, Material components, or headless patterns;
...
1. State the angular.material.angular-cdk-a11y-patterns diagnosis in one concise paragraph.
