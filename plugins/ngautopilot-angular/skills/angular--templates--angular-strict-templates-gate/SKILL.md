...
Use this skill to handle Angular template safety and diagnostics for angular strict templates gate in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular strict templates gate, strict templates, extended diagnostics, template type checking, or remediation;
...
1. State the angular.templates.angular-strict-templates-gate diagnosis in one concise paragraph.
