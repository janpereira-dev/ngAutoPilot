---
id: angular.performance.angular-zoneless-performance-readiness
name: Angular Zoneless Performance Readiness
description: Assess whether a feature or app is ready for zoneless performance-oriented changes.
stack:
  - Angular
...
# Angular Zoneless Performance Readiness

## Purpose

Use this skill to handle Angular performance governance for angular zoneless performance readiness in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular zoneless performance readiness, Core Web Vitals, bundle budgets, zoneless readiness, or performance validation;
...
1. State the angular.performance.angular-zoneless-performance-readiness diagnosis in one concise paragraph.
