---
id: angular.upgrades.testing.angular-v22-injectasync-testing
name: Angular v22 InjectAsync Testing
description: >
  Use this skill for Test injectAsync lazy services, prefetch behavior, error paths, and resolution timing. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: testing
...
Test injectAsync lazy services, prefetch behavior, error paths, and resolution timing.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves test injectasync lazy services, prefetch behavior, error paths, and resolution timing.
...
- Use this skill to review `injectAsync testing` in an Angular 22 migration.
