---
id: angular.modernization.angular-control-flow-v20-migration
name: Angular Control Flow v20 Migration
description: >
  Adopt Angular built-in control flow syntax in bounded post-upgrade modernization slices after Angular 20 is stable. Use when replacing *ngIf, *ngFor, and *ngSwitch with @if, @for, and @switch in a controlled feature slice, not during a version hop.
stack:
  - Angular
  - TypeScript
...
# Angular Control Flow v20 Migration

## Purpose

Adopt Angular built-in control flow syntax in bounded modernization slices after Angular 20 is stable.
