---
id: angular.ai.angular-v22-devserver-self-healing-loop
name: Angular v22 Devserver Self Healing Loop
description: >
  Use this skill for Use devserver build logs as an agent feedback loop while keeping validation deterministic. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ai
...
Use devserver build logs as an agent feedback loop while keeping validation deterministic.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use devserver build logs as an agent feedback loop while keeping validation deterministic.
...
- Use this skill to review `devserver.wait_for_build` in an Angular 22 migration.
