---
name: angular-architecture-angular-version-aware-training-matrix
description: "Builds Angular training matrices that map framework version features, compatibility risks, and learning priorities to enterprise team capabilities and delivery constraints."
license: MIT
metadata:
