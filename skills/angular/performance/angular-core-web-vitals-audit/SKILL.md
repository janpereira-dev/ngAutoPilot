---
id: angular.performance.angular-core-web-vitals-audit
name: Angular Core Web Vitals Audit
description: Measure Angular performance against Core Web Vitals before making optimization changes.
stack:
  - Angular
...
Use this skill to handle Angular performance governance for angular core web vitals audit in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular core web vitals audit, Core Web Vitals, bundle budgets, zoneless readiness, or performance validation;
...
1. State the angular.performance.angular-core-web-vitals-audit diagnosis in one concise paragraph.
