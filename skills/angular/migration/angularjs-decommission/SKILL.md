...
description: Remove AngularJS legacy surface once the replacement is stable and migration checkpoints are complete.
stack:
  - AngularJS
  - Angular
category: migration
...
Use this skill to handle AngularJS to Angular migration planning for angularjs decommission in AngularJS, Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angularjs decommission, AngularJS inventory, ngUpgrade, hybrid routing, services, templates, or decommissioning;
...
1. State the angular.migration.angularjs-decommission diagnosis in one concise paragraph.
