---
id: angular.upgrades.di.angular-v22-injectasync-lazy-service-loading
name: Angular v22 InjectAsync Lazy Service Loading
description: >
  Use this skill for Use injectAsync for lazy service loading only at safe injector and UX boundaries. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
...
triggers:
  ...
  - lazy service
  - code splitting
  - Angular v22 InjectAsync Lazy Service Loading
...
Use injectAsync for lazy service loading only at safe injector and UX boundaries.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use injectasync for lazy service loading only at safe injector and ux boundaries.
...
- Use this skill to review `injectAsync` in an Angular 22 migration.
