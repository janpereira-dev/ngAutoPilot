---
id: angular.upgrades.components.angular-v22-shadow-root-bootstrap-gate
name: Angular v22 Shadow Root Bootstrap Gate
description: >
  Use this skill for Validate Angular bootstrap behavior inside a Shadow Root and CSS/event boundary assumptions. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: components
...
triggers:
  ...
  - bootstrap
  - web components
  - Angular v22 Shadow Root Bootstrap Gate
  - Components / Host Directives
  - Angular 22
compatibility:
  angular:
    min: "22"
...
Validate Angular bootstrap behavior inside a Shadow Root and CSS/event boundary assumptions.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves validate angular bootstrap behavior inside a shadow root and css/event boundary assumptions.
...
- hostDirectives metadata
- dynamic component APIs
...
- Use this skill to review `Shadow Root` in an Angular 22 migration.
