...
Use this skill to handle Angular governance classification for angular compatibility evidence in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular compatibility evidence, migration boundaries, compatibility evidence, validation contracts, or change classification;
...
1. State the angular.governance.angular-compatibility-evidence diagnosis in one concise paragraph.
