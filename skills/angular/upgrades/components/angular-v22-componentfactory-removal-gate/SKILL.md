...
triggers:
  ...
  - ComponentFactory
  - dynamic component
  - Angular v22 ComponentFactory Removal Gate
...
Remove ComponentFactoryResolver and ComponentFactory usage from dynamic component flows.
...
- Use this skill to review `ComponentFactoryResolver` in an Angular 22 migration.
