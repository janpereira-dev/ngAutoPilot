---
id: angular.upgrades.21-to-22.angular-21-to-22-post-upgrade-validation-gate
name: Angular 21 to 22 Post Upgrade Validation Gate
description: >
  Use this skill for Validate the Angular 22 hop after migration and before follow-up modernization. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: upgrade
...
triggers:
  ...
  - Angular 22 validation
  - v22 validation gate
  - Angular 21 to 22 Post Upgrade Validation Gate
  - Hop 21 to 22
  - Angular 22
compatibility:
  angular:
...
Validate the Angular 22 hop after migration and before follow-up modernization.
...
- Use this skill to review `post upgrade validation` in an Angular 22 migration.
