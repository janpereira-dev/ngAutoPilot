---
name: core-project-intake
description: "Collects the minimum repository context needed before an agent changes Angular, TypeScript, JavaScript, testing, architecture, or quality code."
license: MIT
metadata:
