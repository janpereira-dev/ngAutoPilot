---
name: angular-upgrades-21-to-22-angular-21-to-22-upgrade-orchestrator
description: "Use this skill for Coordinate the bounded Angular 21 to 22 hop without mixing modernization into the dependency upgrade. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs."
license: MIT
metadata:
  ngautopilot-id: "angular.upgrades.21-to-22.angular-21-to-22-upgrade-orchestrator"
  ngautopilot-source: "skills/angular/upgrades/21-to-22/angular-21-to-22-upgrade-orchestrator/SKILL.md"
  ngautopilot-version: "0.5.3"
---


# Angular 21 to 22 Upgrade Orchestrator

## Purpose

Coordinate the bounded Angular 21 to 22 hop without mixing modernization into the dependency upgrade.
...
- Use this skill to review `Angular 21 to 22` in an Angular 22 migration.
