...
Use this skill to handle Angular security review for angular domsanitizer governance in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular domsanitizer governance, XSS, DOM sanitization, token storage, SSR security, or dependency triage;
...
1. State the angular.security.angular-domsanitizer-governance diagnosis in one concise paragraph.
