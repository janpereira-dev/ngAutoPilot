---
id: angular.upgrades.router.angular-v22-canmatch-current-snapshot-migration
name: Angular v22 CanMatch Current Snapshot Migration
description: >
  Use this skill for Update CanMatchFn implementations for current snapshot context where Angular 22 requires it. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: router
...
triggers:
  ...
  - currentSnapshot
  - guard migration
  - Angular v22 CanMatch Current Snapshot Migration
  - Router
  - Angular 22
compatibility:
  angular:
...
Update CanMatchFn implementations for current snapshot context where Angular 22 requires it.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves update canmatchfn implementations for current snapshot context where angular 22 requires it.
...
- Use this skill to review `CanMatchFn` in an Angular 22 migration.
