---
id: angular.upgrades.forms.angular-v22-signal-forms-file-upload
name: Angular v22 Signal Forms File Upload
description: >
  Use this skill for Handle file upload state, validation, and FormData boundaries with Signal Forms. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: forms
...
triggers:
  ...
  - FormData
  - Signal Forms
  - Angular v22 Signal Forms File Upload
  - Forms / Signal Forms
  - Angular 22
compatibility:
  angular:
...
Handle file upload state, validation, and FormData boundaries with Signal Forms.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves handle file upload state, validation, and formdata boundaries with signal forms.
...
- Use this skill to review `file upload` in an Angular 22 migration.
