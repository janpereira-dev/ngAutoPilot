---
name: angular-testing-micro-frontends-e2e-validation
description: "Designs and reviews end-to-end validation for Angular micro-frontends in Nx monorepos, covering shell startup, remote loading, cross-remote flows, fallback behavior, and release confidence."
license: MIT
metadata:
