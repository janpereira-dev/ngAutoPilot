---
id: angular.upgrades.build.angular-v22-node-compatibility-gate
name: Angular v22 Node Compatibility Gate
description: >
  Use this skill for Verify Node.js runtime and CI compatibility for the exact Angular 22 target. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: build
...
Verify Node.js runtime and CI compatibility for the exact Angular 22 target.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves verify node.js runtime and ci compatibility for the exact angular 22 target.
...
- Use this skill to review `Node compatibility` in an Angular 22 migration.
