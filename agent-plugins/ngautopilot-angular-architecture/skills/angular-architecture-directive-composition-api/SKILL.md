---
name: angular-architecture-directive-composition-api
description: "Adopt Angular directive composition in bounded slices after the app is stable, using it to reduce inheritance-heavy patterns and share behavior without mixing the change into upgrade work."
license: MIT
metadata:
