---
id: angular.upgrades.ssr.angular-v22-incremental-hydration-default-gate
name: Angular v22 Incremental Hydration Default Gate
description: >
  Use this skill for Validate incremental hydration defaults, event replay, and deferred views before release. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ssr
...
triggers:
  ...
  - event replay
  - hydration
  - Angular v22 Incremental Hydration Default Gate
  - SSR / Hydration
  - Angular 22
compatibility:
  angular:
...
Validate incremental hydration defaults, event replay, and deferred views before release.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves validate incremental hydration defaults, event replay, and deferred views before release.
...
Angular 22 changes ssr / hydration behavior enough that agents need a narrow checklist instead of a generic v22 bucket. The goal is to make the risk visible, testable, and reviewable.
...
- Run SSR/prerender/smoke validation when the target app uses SSR or hydration.
...
- Use this skill to review `incremental hydration` in an Angular 22 migration.
