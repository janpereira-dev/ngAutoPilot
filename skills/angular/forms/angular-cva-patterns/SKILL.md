...
Use this skill to handle Angular forms governance for angular cva patterns in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular cva patterns, typed forms, CVA, signal forms readiness, validation, or form ownership;
...
1. State the angular.forms.angular-cva-patterns diagnosis in one concise paragraph.
