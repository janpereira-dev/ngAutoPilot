---
id: angular.upgrades.templates.angular-v22-duplicate-selector-diagnostic-gate
name: Angular v22 Duplicate Selector Diagnostic Gate
description: >
  Use this skill for Resolve multiple directive/component selectors matching the same element when diagnostics flag ambiguity. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: templates
...
triggers:
  ...
  - selector diagnostic
  - template compiler
  - Angular v22 Duplicate Selector Diagnostic Gate
  - Templates / Compiler
  - Angular 22
compatibility:
  angular:
...
Resolve multiple directive/component selectors matching the same element when diagnostics flag ambiguity.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves resolve multiple directive/component selectors matching the same element when diagnostics flag ambiguity.
...
- Use this skill to review `duplicate selector` in an Angular 22 migration.
