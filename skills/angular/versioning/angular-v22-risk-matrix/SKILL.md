---
id: angular.versioning.angular-v22-risk-matrix
name: Angular v22 Risk Matrix
description: >
  Use this skill for Classify Angular 22 risks by domain, severity, validation need, and PR slicing recommendation. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: versioning
...
Classify Angular 22 risks by domain, severity, validation need, and PR slicing recommendation.
...
- Use this skill to review `Angular v22 risk matrix` in an Angular 22 migration.
