---
id: angular.modernization.angular-zoneless-readiness-v20
name: Angular Zoneless Readiness v20
description: >
  Prepare an Angular app for zoneless execution in bounded post-upgrade modernization slices after Angular 20 is stable. Use when reducing reliance on Zone.js timing, event patching assumptions, and implicit change detection behavior without mixing the work into a version hop.
stack:
  - Angular
  - TypeScript
...
# Angular Zoneless Readiness v20

## Purpose

Prepare an Angular app for zoneless execution in bounded modernization slices after Angular 20 is stable.

## When to Use

- The app is already on stable Angular 20.
