---
id: angular.versioning.angular-v22-roadmap-alignment
name: Angular v22 Roadmap Alignment
description: >
  Use this skill for Align Angular 22 recommendations with official roadmap status and avoid premature adoption of unfinished work. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: versioning
