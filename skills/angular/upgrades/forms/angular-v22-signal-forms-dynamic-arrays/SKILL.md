---
id: angular.upgrades.forms.angular-v22-signal-forms-dynamic-arrays
name: Angular v22 Signal Forms Dynamic Arrays
description: >
  Use this skill for Model dynamic collections with signal-backed arrays instead of copying FormArray mental models blindly. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: forms
...
triggers:
  ...
  - FormArray
  - Signal Forms
  - Angular v22 Signal Forms Dynamic Arrays
  - Forms / Signal Forms
  - Angular 22
compatibility:
  angular:
...
Model dynamic collections with signal-backed arrays instead of copying FormArray mental models blindly.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves model dynamic collections with signal-backed arrays instead of copying formarray mental models blindly.
...
- Use this skill to review `dynamic arrays` in an Angular 22 migration.
