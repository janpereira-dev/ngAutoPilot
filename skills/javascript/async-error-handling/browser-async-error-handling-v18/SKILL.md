---
id: javascript.async-error-handling.browser-async-error-handling-v18
name: Browser Async Error Handling v18+
description: >
...
# Browser Async Error Handling v18+

## Purpose

Use this skill for browser-facing async error handling where user experience and safe fallback behavior matter.

This variant emphasizes failure visibility in UI, retry behavior, and safe continuation when the browser can recover.
