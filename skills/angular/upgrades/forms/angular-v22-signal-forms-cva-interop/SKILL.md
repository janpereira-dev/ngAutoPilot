---
id: angular.upgrades.forms.angular-v22-signal-forms-cva-interop
name: Angular v22 Signal Forms CVA Interop
description: >
  Use this skill for Bridge Signal Forms with existing CVA and reactive-forms components without a forced rewrite. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: forms
...
triggers:
  ...
  - Angular v22 Signal Forms CVA Interop
  - Forms / Signal Forms
  - Angular 22
compatibility:
  angular:
...
Bridge Signal Forms with existing CVA and reactive-forms components without a forced rewrite.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves bridge signal forms with existing cva and reactive-forms components without a forced rewrite.
...
- Use this skill to review `CVA` in an Angular 22 migration.
