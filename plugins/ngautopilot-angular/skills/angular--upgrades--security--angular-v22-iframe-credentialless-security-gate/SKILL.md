---
id: angular.upgrades.security.angular-v22-iframe-credentialless-security-gate
name: Angular v22 Iframe Credentialless Security Gate
description: >
  Use this skill for Treat iframe credentialless and embedded boundaries as security-sensitive. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: security
...
Treat iframe credentialless and embedded boundaries as security-sensitive.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves treat iframe credentialless and embedded boundaries as security-sensitive.
...
- Use this skill to review `iframe credentialless` in an Angular 22 migration.
