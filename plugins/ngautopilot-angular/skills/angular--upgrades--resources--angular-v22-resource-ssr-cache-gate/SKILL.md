---
id: angular.upgrades.resources.angular-v22-resource-ssr-cache-gate
name: Angular v22 Resource SSR Cache Gate
description: >
  Use this skill for Validate resource/httpResource SSR cache, transfer cache, credential, and privacy boundaries. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: resources
...
Validate resource/httpResource SSR cache, transfer cache, credential, and privacy boundaries.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves validate resource/httpresource ssr cache, transfer cache, credential, and privacy boundaries.
...
- Use this skill to review `resource SSR` in an Angular 22 migration.
