---
id: angular.ai.angular-v22-ai-tutor-safe-usage
name: Angular v22 AI Tutor Safe Usage
description: >
  Use this skill for Use AI tutor workflows to teach Angular concepts without allowing unsafe code or secret exposure. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ai
...
Use AI tutor workflows to teach Angular concepts without allowing unsafe code or secret exposure.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use ai tutor workflows to teach angular concepts without allowing unsafe code or secret exposure.
...
- Use this skill to review `ai_tutor` in an Angular 22 migration.
