---
id: angular.upgrades.templates.angular-v22-template-arrow-functions-governance
name: Angular v22 Template Arrow Functions Governance
description: >
  Use this skill for Allow inline template arrow functions only when they are trivial and performance-safe. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: templates
...
triggers:
  ...
  - template functions
  - inline functions
  - Angular v22 Template Arrow Functions Governance
  - Templates / Compiler
  - Angular 22
compatibility:
  angular:
...
Allow inline template arrow functions only when they are trivial and performance-safe.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves allow inline template arrow functions only when they are trivial and performance-safe.
...
- Use this skill to review `arrow functions` in an Angular 22 migration.
