---
id: angular.upgrades.ssr.angular-v22-transferstate-security-hardening
name: Angular v22 TransferState Security Hardening
description: >
  Use this skill for Harden TransferState against sensitive data leaks, cache mistakes, and DOM clobbering risk. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ssr
...
triggers:
  ...
  - SSR security
  - DOM clobbering
  - Angular v22 TransferState Security Hardening
  - SSR / Hydration
  - Angular 22
compatibility:
  angular:
...
Harden TransferState against sensitive data leaks, cache mistakes, and DOM clobbering risk.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves harden transferstate against sensitive data leaks, cache mistakes, and dom clobbering risk.
...
- Use this skill to review `TransferState` in an Angular 22 migration.
