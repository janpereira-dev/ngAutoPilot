...
triggers:
  ...
  - TS 6
  - compatibility
  - Angular v22 TypeScript 6 Compatibility Gate
  - Build / Tooling
  - Angular 22
compatibility:
  angular:
...
Verify TypeScript 6 compatibility and diagnostics from the official Angular compatibility matrix before upgrading.
...
- Use this skill to review `TypeScript 6` in an Angular 22 migration.
