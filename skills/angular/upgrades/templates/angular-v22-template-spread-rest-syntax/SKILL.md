---
id: angular.upgrades.templates.angular-v22-template-spread-rest-syntax
name: Angular v22 Template Spread Rest Syntax
description: >
  Use this skill for Use spread/rest in templates only for simple, readable, non-expensive expressions. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: templates
...
triggers:
  ...
  - Angular v22 Template Spread Rest Syntax
  - Templates / Compiler
  - Angular 22
compatibility:
  angular:
...
Use spread/rest in templates only for simple, readable, non-expensive expressions.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves use spread/rest in templates only for simple, readable, non-expensive expressions.
...
- Use this skill to review `spread syntax` in an Angular 22 migration.
