---
name: angular-architecture-defer-lazy-loading-modernization
description: "Adopt Angular defer blocks and modern lazy loading in bounded post-upgrade modernization slices to improve render timing, route splitting, and loading behavior without mixing the change into an Angular version hop."
license: MIT
metadata:
  ngautopilot-id: "angular.architecture.defer-lazy-loading-modernization"
  ngautopilot-source: "skills/angular/architecture/defer-lazy-loading-modernization/SKILL.md"
