---
id: angular.upgrades.ssr.angular-v22-origin-validation-hardening
name: Angular v22 Origin Validation Hardening
description: >
  Use this skill for Validate SSR host/origin handling and reverse-proxy assumptions. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ssr
...
triggers:
  ...
  - host validation
  - SSR
  - Angular v22 Origin Validation Hardening
  - SSR / Hydration
  - Angular 22
compatibility:
  angular:
...
Validate SSR host/origin handling and reverse-proxy assumptions.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves validate ssr host/origin handling and reverse-proxy assumptions.
...
- Use this skill to review `origin validation` in an Angular 22 migration.
