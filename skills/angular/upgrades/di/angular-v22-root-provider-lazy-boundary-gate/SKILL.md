...
triggers:
  - root provider
  - lazy boundary
  - auto-provided service
  - Angular v22 Root Provider Lazy Boundary Gate
...
Prevent injectAsync usage where services are not auto-provided or cross the wrong provider boundary.
...
- Use this skill to review `root provider` in an Angular 22 migration.
