---
name: angular-architecture-angular-enterprise-primitives
description: "Coordinates the enterprise learning and review path for Angular forms, signals, and testing so teams can adopt the right primitive at the right version and maturity level."
license: MIT
metadata:
