---
id: angular.upgrades.http.angular-v22-http-progress-migration
name: Angular v22 HTTP Progress Migration
description: >
  Use this skill for Migrate HTTP progress handling to explicit upload/download progress options when Angular 22 diagnostics require it. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: resources
...
triggers:
  ...
  - upload progress
  - download progress
  - Angular v22 HTTP Progress Migration
  - Resources / HTTP
  - Angular 22
compatibility:
  angular:
...
Migrate HTTP progress handling to explicit upload/download progress options when Angular 22 diagnostics require it.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves migrate http progress handling to explicit upload/download progress options when angular 22 diagnostics require it.
...
- SSR transfer cache settings
- sensitive response boundaries
...
- Use this skill to review `reportProgress` in an Angular 22 migration.
