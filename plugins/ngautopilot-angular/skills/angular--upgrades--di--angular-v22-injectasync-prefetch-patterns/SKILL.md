---
id: angular.upgrades.di.angular-v22-injectasync-prefetch-patterns
name: Angular v22 InjectAsync Prefetch Patterns
description: >
  Use this skill for Prefetch injectAsync dependencies with safe triggers such as idle time without hiding failures. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
...
Prefetch injectAsync dependencies with safe triggers such as idle time without hiding failures.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves prefetch injectasync dependencies with safe triggers such as idle time without hiding failures.
...
- Use this skill to review `injectAsync prefetch` in an Angular 22 migration.
