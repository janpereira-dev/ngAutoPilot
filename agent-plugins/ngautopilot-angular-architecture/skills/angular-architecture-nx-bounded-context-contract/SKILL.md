---
name: angular-architecture-nx-bounded-context-contract
description: "Audits Nx monorepo tagging and dependency constraints for Angular bounded contexts so shared UI, shared domain, and shared data-access libraries remain explicitly separated and enforceable."
license: MIT
metadata:
