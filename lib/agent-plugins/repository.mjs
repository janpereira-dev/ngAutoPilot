...
export function resolveAngularInstallation({ root, projectRoot, target, profile = 'core', capabilities = [] }) {
  ...
  if (packageOnlyRange && requestedTarget.minor === undefined) {
    if (findSatisfiableAngularMinor(requestedTarget.major, evidence.angular.declarations) === undefined) {
  ...
  const effectiveAngularTarget = !packageOnlyRange && requestedTarget.minor === undefined
    ? { ...requestedTarget, minor: evidence.angular.minor }
    : requestedTarget;
