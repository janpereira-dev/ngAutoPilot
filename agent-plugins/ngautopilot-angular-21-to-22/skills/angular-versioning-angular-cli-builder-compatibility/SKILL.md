---
name: angular-versioning-angular-cli-builder-compatibility
...
- the task mentions angular cli builder compatibility, compatibility matrix, peer dependencies, CLI builders, Node, TypeScript, or RxJS versions;
