---
id: angular.router.angular-lazy-loading-routes
name: Angular Lazy Loading Routes
description: Apply lazy loading safely to Angular routes with clear boundaries and validation.
stack:
  - Angular
category: router
status: stable
...
Use this skill to handle Angular router design for angular lazy loading routes in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular lazy loading routes, route configuration, lazy loading, guards, resolvers, or router tests;
...
1. State the angular.router.angular-lazy-loading-routes diagnosis in one concise paragraph.
