---
id: angular.signals.angular-rxjs-signals-interop
name: Angular RxJS Signals Interop
description: Bridge RxJS and signals with explicit conversion boundaries and lifecycle safety.
stack:
  - Angular
  - RxJS
category: signals
...
Use this skill to handle Angular Signals design for angular rxjs signals interop in Angular, RxJS projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular rxjs signals interop, signals, computed, effects, RxJS interop, or signal state;
