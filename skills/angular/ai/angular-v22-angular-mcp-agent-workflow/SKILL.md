---
id: angular.ai.angular-v22-angular-mcp-agent-workflow
name: Angular v22 Angular MCP Agent Workflow
description: >
  Use this skill for Integrate Angular MCP agent workflows without vendor lock-in or hidden local assumptions. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ai
...
Integrate Angular MCP agent workflows without vendor lock-in or hidden local assumptions.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves integrate angular mcp agent workflows without vendor lock-in or hidden local assumptions.
...
- Use this skill to review `Angular MCP` in an Angular 22 migration.
