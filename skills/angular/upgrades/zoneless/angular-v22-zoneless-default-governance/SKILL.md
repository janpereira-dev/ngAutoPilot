---
id: angular.upgrades.zoneless.angular-v22-zoneless-default-governance
name: Angular v22 Zoneless Default Governance
description: >
  Use this skill for Decide whether an Angular 22 app can run zoneless by default or needs a safe bridge. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
...
triggers:
  ...
  - Zone.js
  - change detection
  - Angular v22 Zoneless Default Governance
...
Decide whether an Angular 22 app can run zoneless by default or needs a safe bridge.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves decide whether an angular 22 app can run zoneless by default or needs a safe bridge.
...
- Use this skill to review `zoneless` in an Angular 22 migration.
