...
2. Create an annotated or signed `v0.8.0` tag according to maintainer policy after all repository checks pass.
...
The packet in [`openai/submission/0.8.0/`](../openai/submission/0.8.0/) is intentionally honest: it records that the package is not submitted and not OpenAI verified. It does not claim portal approval or developer verification.
