---
id: angular.upgrades.ssr.angular-v22-ssr-resource-cache-validation
name: Angular v22 SSR Resource Cache Validation
description: >
  Use this skill for Check resource/httpResource SSR caches for credentialed requests and private data leakage. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: ssr
...
triggers:
  ...
  - Angular v22 SSR Resource Cache Validation
  - SSR / Hydration
  - Angular 22
compatibility:
  angular:
...
Check resource/httpResource SSR caches for credentialed requests and private data leakage.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves check resource/httpresource ssr caches for credentialed requests and private data leakage.
...
- Use this skill to review `SSR resource cache` in an Angular 22 migration.
