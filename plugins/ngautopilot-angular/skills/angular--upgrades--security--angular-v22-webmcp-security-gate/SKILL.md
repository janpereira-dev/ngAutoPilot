---
id: angular.upgrades.security.angular-v22-webmcp-security-gate
name: Angular v22 WebMCP Security Gate
description: >
  Use this skill for Expose WebMCP tools only with explicit permissions, narrow schemas, and no secret or destructive surface. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: security
...
triggers:
  ...
  - tool exposure
  - agent security
  - Angular v22 WebMCP Security Gate
  - Security
  - Angular 22
compatibility:
  angular:
...
Expose WebMCP tools only with explicit permissions, narrow schemas, and no secret or destructive surface.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves expose webmcp tools only with explicit permissions, narrow schemas, and no secret or destructive surface.
...
- Use this skill to review `WebMCP` in an Angular 22 migration.
