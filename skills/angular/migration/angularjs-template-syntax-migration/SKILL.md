...
description: Migrate AngularJS template syntax to Angular template syntax with minimal behavioral drift.
stack:
  - AngularJS
  - Angular
category: migration
...
Use this skill to handle AngularJS to Angular migration planning for angularjs template syntax migration in AngularJS, Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angularjs template syntax migration, AngularJS inventory, ngUpgrade, hybrid routing, services, templates, or decommissioning;
...
1. State the angular.migration.angularjs-template-syntax-migration diagnosis in one concise paragraph.
