---
name: angular-architecture-facade-pattern
description: "Introduces or reviews Angular facades that provide a focused feature API over data access, state, permissions, navigation, and orchestration."
license: MIT
metadata:
