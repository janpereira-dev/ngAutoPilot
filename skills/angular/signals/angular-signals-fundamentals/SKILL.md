---
id: angular.signals.angular-signals-fundamentals
name: Angular Signals Fundamentals
description: Establish safe signal usage with clear boundaries for state, derivation, and side effects.
stack:
  - Angular
category: signals
status: stable
...
Use this skill to handle Angular Signals design for angular signals fundamentals in Angular projects without mixing it with unrelated migration, modernization, or cleanup work.
...
- the task mentions angular signals fundamentals, signals, computed, effects, RxJS interop, or signal state;
...
1. State the angular.signals.angular-signals-fundamentals diagnosis in one concise paragraph.
