---
id: angular.upgrades.router.angular-v22-route-injector-auto-cleanup
name: Angular v22 Route Injector Auto Cleanup
description: >
  Use this skill for Evaluate withExperimentalAutoCleanupInjectors for route-level providers and disposal safety. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: router
...
triggers:
  ...
  - route injector
  - cleanup
  - Angular v22 Route Injector Auto Cleanup
  - Router
  - Angular 22
compatibility:
  angular:
...
Evaluate withExperimentalAutoCleanupInjectors for route-level providers and disposal safety.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves evaluate withexperimentalautocleanupinjectors for route-level providers and disposal safety.
...
- Use this skill to review `withExperimentalAutoCleanupInjectors` in an Angular 22 migration.
