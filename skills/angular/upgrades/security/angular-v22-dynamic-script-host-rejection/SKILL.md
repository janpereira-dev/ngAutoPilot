---
id: angular.upgrades.security.angular-v22-dynamic-script-host-rejection
name: Angular v22 Dynamic Script Host Rejection
description: >
  Use this skill for Remove or redesign dynamic script host patterns that Angular rejects for security. Use when Angular 22 work needs concern-first routing, explicit validation, and no invented APIs.
stack:
  - Angular
  - TypeScript
category: security
...
triggers:
  ...
  - script host
  - security
  - Angular v22 Dynamic Script Host Rejection
  - Security
  - Angular 22
compatibility:
  angular:
...
Remove or redesign dynamic script host patterns that Angular rejects for security.

Keep the work concern-first: this skill handles one risk area and does not replace the Angular 21 to 22 hop orchestrator.

## When to Use

- The task specifically involves remove or redesign dynamic script host patterns that angular rejects for security.
...
- Use this skill to review `dynamic script` in an Angular 22 migration.
