...
triggers:
  ...
  - Angular v22 Agent Skills Integration
  - AI / MCP / WebMCP
  - Angular 22
compatibility:
  angular:
...
Use official Angular Agent Skills as reference material without copying them blindly or replacing NgAutoPilot routing.
...
- Use this skill to review `Angular Agent Skills` in an Angular 22 migration.
