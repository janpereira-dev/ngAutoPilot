...
export function resolveAngularInstallation({ root, projectRoot, target, profile = 'core', capabilities = [] }) {
  ...
  return {
    ...
    included: [
      ...
      ...compatibleSkills.map(({ skill, packIds, compatibility }) => ({ type: 'skill', id: skill.id, reason: skillReason(compatibilityReason(compatibility, effectiveAngularMajor), packIds) })),
    ],
    excluded: [
